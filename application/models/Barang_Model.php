...
class Barang_Model extends CI_Model
{
    ...
    public function join_all()
    {
        ...
        LEFT JOIN tb_user ON tb_barang.id_user=tb_user.id_user 
        LEFT JOIN tb_kategori ON tb_barang.id_kategori=tb_kategori.id_kategori 
        LEFT JOIN tb_gambar ON tb_barang.id_barang=tb_gambar.id_barang 
        LEFT JOIN tb_store ON tb_barang.id_store=tb_store.id_store")->result();
    }
